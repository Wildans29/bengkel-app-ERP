...
<div class="card max-w-2xl">
    ...
    <form method="POST" action="<?php echo e(route('items.store')); ?>" class="space-y-5">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\inventory-app\resources\views/items/create.blade.php ENDPATH**/ ?>