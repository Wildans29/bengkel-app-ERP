    ...
    <aside
        ...
        <nav class="space-y-2">
            ...
            <a href="<?php echo e(route('items.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('items.*') ? 'active' : ''); ?>">
                <i class="bi bi-box-seam"></i> Barang
            </a>

            <a href="<?php echo e(route('estimations.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('estimations.*') ? 'active' : ''); ?>">
    ...
    <main class="flex-1 w-full max-w-7xl mx-auto p-4 md:p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-lg md:text-xl font-semibold"><?php echo $__env->yieldContent('title'); ?></h1>
            </div>
        ...
        <div class="flex flex-col min-h-[calc(100vh-120px)]">
            ...
            <footer class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4 text-sm text-gray-500 dark:text-gray-400 flex flex-col md:flex-row justify-between items-center gap-2">
                ...
                <span>
                    © <?php echo e(date('Y')); ?> <strong>Bengkel App</strong>. All rights reserved.
                </span>
...
<?php /**PATH C:\laragon\www\inventory-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>